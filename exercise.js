...
// when trying to convert the String data type to a Number data type, it will always evaluates to NaN (Not a Number), which makes sense, you can't cast strings to numbers, unless the string contains only numbers/floats, in that case it can be casted to a Number data type.
